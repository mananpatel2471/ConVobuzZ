      ...
      <div className=" flex flex-col w-full   border h-[calc(100vh_-_115px)]">
        ...
        <div className=" bg-[#BDCDD6]  px-4 py-2 flex items-center">
          ...
          <div className="flex-1 mx-4  relative">
            ...
            />
            <button
              className="flex p-2 absolute right-1 top-0.5 rounded-lg  text-black hover:bg-gray-300 dark:hover:text-gray-400 dark:hover:bg-gray-900 disabled:hover:bg-transparent dark:disabled:hover:bg-transparent ">
              <svg
                className="w-5 h-5 "
                viewBox="0 0 17 17"
                fill="none"
